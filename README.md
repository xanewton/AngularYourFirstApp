...
```
    ng new AngularYourFirstApp
```

3. Download code and follow guide on [Angular Tutorial](https://angular.io/start).

4. In your new CLI generated app, replace the /src folder with the one from your StackBlitz download.
